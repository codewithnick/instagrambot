...
##            #wait for typing then post
##            time.sleep(random.randint(5,9))
##            postbutton = driver.find_element_by_xpath('/html/body/div[1]/section/main/div/div[1]/article/div[3]/section[3]/div/form/button')
...
##                                                      #/html/body/div[1]/section/main/div/div[1]/article/div[3]/section[3]/div[1]/form/button[2]
##            postbutton.click()
##            #comment posted
##            commentlimit-=1
##            time.sleep(random.randint(5,9))
##            print('commented on '+postlink)
##            print(str(commentlimit)+'left to be commented')
##        except:
##            traceback.print_exc()
##            print('could not comment trying next post')
##    print('hourly commenting limit reached')
##    print(time.ctime(time.time()) )

    #unfollow 10 people
##    time.sleep(random.randint(5,9))
##    profilelink = driver.find_element_by_xpath('/html/body/div[1]/section/nav/div[2]/div/div/div[3]/div/div[4]/button')
##    profilelink.click()
##    time.sleep(random.randint(5,9))
    while followlimit>0:
        try:            
            driver.get('https://www.instagram.com/'+user['username']+'/following/')
            time.sleep(random.randint(5,9))
            unfollow = driver.find_element_by_xpath('/html/body/div[4]/div/div/div[2]/ul/div/li[1]/div/div[3]/button')                                                        
            unfollow.click()
            print(str(followlimit)+'left to be unfollowed')
        except:
            traceback.print_exc()
            print('could not unfollow trying next')
        followlimit-=1
...
##            followbutton.click()                                        
##            time.sleep(1)
##            print(str(followlimit)+'left to be followed')
##        except:
##            traceback.print_exc()
##            print('could not follow trying next')
##            pass
##        followlimit-=1
##    print('hourly follow limit reached')
##    print(time.ctime(time.time()) )
...
##    while dmlimit>0:
##        try:
##            followlink=random.choice(dmarray)
##            dmarray.remove(followlink)
##            driver.get(followlink)
##            time.sleep(random.randint(5,9))
##            #getpost
##            ###most recent post###
...
##            print(str(dmlimit)+'left to be found')
##        except:
##            traceback.print_exc()
##            print('could not find trying next')
##            pass
##        dmlimit-=1
##    
    #now dm them
##    while True:
##        #loop to close not now button
...
##            pass
##    print('hourly dm limit reached')
##    print(time.ctime(time.time()) )
##    print('ended iteration for ',user)
##    driver.quit()
##    #process for all users ended
##    print('process for all users ended')
    #checking if 18 hours completed
##    endhour=int(datetime.datetime.now().hour)
##    difference=0
##    temp=starthour
##    while(temp!=endhour):
##        if(temp==24):
